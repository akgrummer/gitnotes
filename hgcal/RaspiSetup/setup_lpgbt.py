...
class SetupLPGBT:
    ...
    def __init__(self, device="/dev/i2c-1", address=0x70, mode=Mode.V2_WAGON, protocol="I2C", xml="file://connections.xml",uhaldevice="zcu"):
    ...
    def setup_core(self):
        ...
        self.iic.write_lpgbt(0x37,0x18)
    ...
    def setup_core_trig(self, doreset, ids=["B","C"]):
        ...
        for lpgbt_id in ids:
            ...
            self.iic.write_lpgbt_trig(lpgbt_id,0x37,0x18)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dev',default='/dev/i2c-1',help="I2C device to use")
